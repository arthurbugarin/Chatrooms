...
async def connectionHandler(web_socket, path):
    # Register.
...
async def serve():                                                                                           
    server = await websockets.serve(connectionHandler, '127.0.0.1', PORT)
